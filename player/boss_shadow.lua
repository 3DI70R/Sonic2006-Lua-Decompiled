...
function SetupModuleSub(_ARG_0_)
  ...
  OpenSound(_ARG_0_, sound_module_bossshadow, "boss_shadow")
  OpenAI(_ARG_0_, ai_module_boss_shadow)
...
debug = not_use
c_module_state = state_module_boss_shadow
...
c_model_package = "player/boss_shadow"
