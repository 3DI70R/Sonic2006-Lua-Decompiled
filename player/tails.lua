...
function SetupModuleSub(_ARG_0_)
  ...
  OpenWeapons(_ARG_0_, other_module_tails_weapons)
  OpenOther(_ARG_0_, other_module_amigo_change)
  OpenEffect(_ARG_0_, effect_module_tails, "player_tails")
  OpenSound(_ARG_0_, sound_module_tails, "player_tails")
