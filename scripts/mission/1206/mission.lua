g_mission_information = {
  ...
  mission_set_default = "scripts/mission/1206/set_mission_1206_01.XML",
...
function on_event(_ARG_0_, _ARG_1_)
  if _ARG_1_ == "d1206" then
    SetGlobalFlag(_ARG_0_, 1206, 1)
    Result(_ARG_0_, "g_result_1206")
  elseif _ARG_1_ == "result_1206_end" then
    MissionClear(_ARG_0_, "complete")
  elseif _ARG_1_ == "rule" then
    OpenWindow(_ARG_0_, "msg_m1206_rule006_01_1")
