g_mission_information = {
  ...
  mission_set_default = "scripts/mission/1020/set_mission_1020_00.XML",
...
c_flag_mission_get_robber = c_flag_start + 3
g_message_icon = 0
c_icon_chat = 0
c_icon_hint = 1
c_icon_mission = 2
...
g_result_1020 = {
  ...
  ringbonus_c = 500,
  ringbonus_d = 200,
  finish = "result_1020_end"
}
function main(_ARG_0_)
end
function on_talk_icon(_ARG_0_, _ARG_1_)
  if _ARG_1_ == "msg_m1020_020" then
  ...
  elseif _ARG_1_ == "msg_m1020_061" then
    if GetTemporaryFlag(_ARG_0_, c_flag_mission_get_robber) == 0 then
      g_message_icon = 2
    elseif GetTemporaryFlag(_ARG_0_, c_flag_mission_get_robber) == 1 then
      g_message_icon = 2
    else
      g_message_icon = 2
    end
...
function on_goto(_ARG_0_, _ARG_1_)
  if g_mission_information.mission_area == "twn/sonic/b" then
    if _ARG_1_ == "goto_mission_scene" then
      ...
      g_mission_information.mission_set_default = "scripts/mission/1020/set_mission_1020_01.XML"
      g_mission_information.mission_is_battle = true
      ChangeArea(_ARG_0_, g_mission_information.mission_area)
    elseif _ARG_1_ == "goto_mission_end" then
      g_mission_information.mission_terrain = "stage/twn/b/"
      g_mission_information.mission_area = "twn/sonic/b"
      g_mission_information.mission_set_default = "scripts/mission/1020/set_mission_1020_00.XML"
...
function on_event(_ARG_0_, _ARG_1_)
  ...
  elseif _ARG_1_ == "FAILD_FLAG" then
    ...
    on_goto(_ARG_0_, "goto_mission_end")
    StartCountdown(_ARG_0_, 0, "")
  elseif _ARG_1_ == "result_1020_end" then
    MissionClear(_ARG_0_, "complete")
  elseif _ARG_1_ == "rule" then
    OpenWindow(_ARG_0_, "msg_m1020_title020_01_1")
...
function on_talk_close(_ARG_0_, _ARG_1_)
  if _ARG_1_ == "msg_m1020_020_01_3" then
    SetTemporaryFlag(_ARG_0_, c_flag_mission_start, 1)
    on_goto(_ARG_0_, "goto_mission_scene")
  elseif _ARG_1_ == "msg_m1020_020_01_4" then
    Result(_ARG_0_, "g_result_1020")
  elseif _ARG_1_ == "msg_m1020_020_01_5" then
    MissionClear(_ARG_0_, "failed")
  elseif _ARG_1_ == "msg_m1020_061_01_1" then
    SetTemporaryFlag(_ARG_0_, c_flag_mission_get_robber, 1)
  elseif _ARG_1_ == "msg_m1020_061_01_2" then
    SetTemporaryFlag(_ARG_0_, c_flag_mission_get_robber, 2)
  elseif _ARG_1_ == "msg_m1020_061_01_3" then
    SetTemporaryFlag(_ARG_0_, c_flag_mission_success, 1)
    on_goto(_ARG_0_, "goto_mission_end")
  end
end
