g_mission_information = {
  mission_string = "msg_m1132_title032_01_1",
  mission_area = "twn/shadow/a",
  mission_terrain = "stage/twn/a",
  mission_set_default = "scripts/mission/1132/set_mission_1132_00.XML",
  mission_is_battle = false,
  mission_text = "text/msg_town_mission_shadow.mst",
  mission_event_start = "",
  mission_event_end = "",
  mission_kynapse_default = "scripts/mission/1132/mission_1132.kbf",
...
g_result_1132 = {
  ...
  ringbonus_c = 200,
  ringbonus_d = 100,
  finish = "result_1132_end"
}
function main(_ARG_0_)
end
function on_talk_icon(_ARG_0_, _ARG_1_)
  if _ARG_1_ == "msg_m1132_132" then
...
function on_goto(_ARG_0_, _ARG_1_)
  if g_mission_information.mission_area == "twn/shadow/a" then
    if _ARG_1_ == "goto_mission_scene" then
      ...
      g_mission_information.mission_set_default = "scripts/mission/1132/set_mission_1132_01.XML"
      g_mission_information.mission_is_battle = true
      ChangeArea(_ARG_0_, g_mission_information.mission_area)
    elseif _ARG_1_ == "goto_mission_end" then
      g_mission_information.mission_terrain = "stage/twn/a"
      g_mission_information.mission_area = "twn/shadow/a"
      g_mission_information.mission_set_default = "scripts/mission/1132/set_mission_1132_00.XML"
...
function on_talk_close(_ARG_0_, _ARG_1_)
  if _ARG_1_ == "msg_m1132_132_01_1" then
    SetTemporaryFlag(_ARG_0_, c_flag_mission_start, 1)
    on_goto(_ARG_0_, "goto_mission_scene")
  elseif _ARG_1_ == "msg_m1132_132_01_2" then
    SetGlobalFlag(_ARG_0_, 1132, 1)
    Result(_ARG_0_, "g_result_1132")
  end
end
