g_mission_information = {
  mission_string = "sonic_stg_wap",
  mission_area = "wap/sonic/a",
  mission_terrain = "stage/wap/a/",
  mission_set_default = "scripts/mission/2000/set_wap_a_sonic_h.XML",
...
function on_event(_ARG_0_, _ARG_1_)
  if _ARG_1_ == "goto_b" then
    ...
    g_mission_information.mission_set_default = "scripts/mission/2000/set_wap_b_sonic_h.XML"
