g_mission_information = {
  mission_string = "sonic_stg_flc",
  mission_area = "flc/sonic/a",
  mission_terrain = "stage/flc/a/",
  mission_set_default = "scripts/mission/2000/set_flc_a_sonic_h.xml",
...
function on_event(_ARG_0_, _ARG_1_)
  if _ARG_1_ == "AtoB" then
    ...
    g_mission_information.mission_set_default = "scripts/mission/2000/set_flc_b_sonic_h.xml"
