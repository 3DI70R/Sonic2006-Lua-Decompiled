g_mission_information = {
  ...
  mission_set_default = "scripts/mission/2000/set_tpjA_sonic_h.XML",
...
function on_event(_ARG_0_, _ARG_1_)
  if _ARG_1_ == "AtoB" then
    ...
    g_mission_information.mission_set_default = "scripts/mission/2000/set_tpjB_sonic_h.XML"
