g_mission_information = {
  ...
  mission_set_default = "scripts/mission/1101/set_mission_1101_00.XML",
...
g_result_1101 = {
  ...
  ringbonus_c = 500,
  ringbonus_d = 200,
  finish = "result_1101_end"
}
function main(_ARG_0_)
end
function on_talk_setup(_ARG_0_, _ARG_1_)
  if _ARG_1_ == "msg_m1101_101" then
...
function on_goto(_ARG_0_, _ARG_1_)
  if g_mission_information.mission_area == "twn/shadow/b" then
    if _ARG_1_ == "goto_mission_scene" then
      ...
      g_mission_information.mission_set_default = "scripts/mission/1101/set_mission_1101_01.XML"
      g_mission_information.mission_is_battle = true
      ChangeArea(_ARG_0_, g_mission_information.mission_area)
    elseif _ARG_1_ == "goto_mission_end" then
      g_mission_information.mission_terrain = "stage/twn/b/"
      g_mission_information.mission_area = "twn/shadow/b"
      g_mission_information.mission_set_default = "scripts/mission/1101/set_mission_1101_00_missionman.XML"
...
function on_event(_ARG_0_, _ARG_1_)
  ...
  elseif _ARG_1_ == "failed" then
    ...
    StartCountdown(_ARG_0_, 0, "")
  elseif _ARG_1_ == "result_1101_end" then
    MissionClear(_ARG_0_, "complete")
  elseif _ARG_1_ == "rule" then
    OpenWindow(_ARG_0_, "msg_m1101_rule001_01_1")
    StartCountdown(_ARG_0_, 180, "failed")
  end
end
function on_talk_open(_ARG_0_, _ARG_1_)
end
function on_talk_close(_ARG_0_, _ARG_1_)
  if _ARG_1_ == "msg_m1101_001_01_1" then
    SetTemporaryFlag(_ARG_0_, c_flag_mission_start, 1)
    on_goto(_ARG_0_, "goto_mission_scene")
  elseif _ARG_1_ == "msg_m1101_001_01_2" then
    Result(_ARG_0_, "g_result_11101")
    StartCountdown(_ARG_0_, 0, "")
  end
end
