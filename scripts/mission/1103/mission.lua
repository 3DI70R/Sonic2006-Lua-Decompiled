g_mission_information = {
  mission_string = "msg_m1103_title003_01_1",
  mission_area = "twn/shadow/c",
  mission_terrain = "stage/twn/c/",
  mission_set_default = "scripts/mission/1103/set_mission_1103_00.XML",
...
function on_talk_setup(_ARG_0_, _ARG_1_)
  if _ARG_1_ == "msg_m1103_103" then
    ...
    elseif GetTemporaryFlag(_ARG_0_, c_flag_mission_success) == 1 then
      SetAnimationTalkWith(_ARG_0_, "talk1", "surprise")
      g_name_setuped = "msg_m1103_n103"
...
function on_goto(_ARG_0_, _ARG_1_)
  if _ARG_1_ == "goto_mission_scene" then
    ...
    g_mission_information.mission_set_default = "scripts/mission/1103/set_mission_1103_01.XML"
  ...
  if _ARG_1_ == "goto_mission_end" then
    g_mission_information.mission_terrain = "stage/twn/c"
    g_mission_information.mission_area = "twn/shadow/c"
    g_mission_information.mission_set_default = "scripts/mission/1103/set_mission_1103_00.XML"
    g_mission_information.mission_is_battle = false
    ChangeArea(_ARG_0_, g_mission_information.mission_area)
  end
end
function on_event(_ARG_0_, _ARG_1_)
  if _ARG_1_ == "d1103" then
  ...
  elseif _ARG_1_ == "failed" then
    ...
    StartCountdown(_ARG_0_, 0, "")
    on_goto(_ARG_0_, "goto_mission_end")
  elseif _ARG_1_ == "result_1103_end" then
    MissionClear(_ARG_0_, "complete")
  elseif _ARG_1_ == "rule" then
    OpenWindow(_ARG_0_, "msg_m1103_rule003_01_1")
...
function on_talk_close(_ARG_0_, _ARG_1_)
  if _ARG_1_ == "msg_m1103_103_01_3" then
    SetTemporaryFlag(_ARG_0_, c_flag_mission_start, 1)
    on_goto(_ARG_0_, "goto_mission_scene")
  elseif _ARG_1_ == "msg_m1103_103_01_4" then
    SetGlobalFlag(_ARG_0_, 1103, 1)
    Result(_ARG_0_, "g_result_1103")
  elseif _ARG_1_ == "msg_m1103_103_01_5" then
