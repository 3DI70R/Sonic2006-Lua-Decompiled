g_mission_information = {
  mission_string = "shadow_stg_aqa",
  mission_area = "aqa/shadow/a",
  mission_terrain = "stage/aqa/a/",
  mission_set_default = "scripts/mission/2100/set_aqaA_shadow_h.XML",
...
function on_event(_ARG_0_, _ARG_1_)
  if _ARG_1_ == "goto_b" then
    ...
    g_mission_information.mission_set_default = "scripts/mission/2100/set_aqaB_shadow_h.XML"
