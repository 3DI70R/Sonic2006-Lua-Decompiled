g_mission_information = {
  mission_string = "shadow_stg_rdt",
  mission_area = "rct/shadow/a",
  mission_terrain = "stage/rct/a/",
  mission_set_default = "scripts/mission/2100/set_rctA_shadow_h.XML",
...
function on_event(_ARG_0_, _ARG_1_)
  if _ARG_1_ == "AtoB" then
    ...
    g_mission_information.mission_set_default = "scripts/mission/2100/set_rctB_shadow_h.XML"
