g_mission_information = {
  mission_string = "msg_m1240_title052_01_1",
  mission_area = "twn/silver/b",
  mission_terrain = "stage/twn/b/",
  mission_set_default = "scripts/mission/1240/set_mission_1240.XML",
...
g_result_1240 = {
  ...
  ringbonus_c = 200,
  ringbonus_d = 100,
  finish = "result_1240_end"
}
function main(_ARG_0_)
end
function on_talk_icon(_ARG_0_, _ARG_1_)
  if _ARG_1_ == "msg_m1240_240" then
    g_message_icon = 3
  end
end
...
function on_goto(_ARG_0_, _ARG_1_)
  if g_mission_information.mission_area == "twn/silver/b" then
    if _ARG_1_ == "goto_mission_end" then
      ...
      g_mission_information.mission_set_default = "scripts/mission/1240/set_mission_1240_00.XML"
...
function on_event(_ARG_0_, _ARG_1_)
  if _ARG_1_ == "d1240" then
    SetGlobalFlag(_ARG_0_, 1240, 1)
    Result(_ARG_0_, "g_result_1240")
  elseif _ARG_1_ == "found_player" then
    on_goto(_ARG_0_, "goto_mission_end")
  elseif _ARG_1_ == "result_1240_end" then
    MissionClear(_ARG_0_, "complete")
  elseif _ARG_1_ == "rule" then
    OpenWindow(_ARG_0_, "msg_m1240_title052_01_1")
...
function on_talk_close(_ARG_0_, _ARG_1_)
  if _ARG_1_ == "msg_m1240_240_01_1" then
