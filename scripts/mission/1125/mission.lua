g_mission_information = {
  ...
  mission_set_default = "scripts/mission/1125/set_mission_1125_00.XML",
...
g_result_1125 = {
  ...
  ringbonus_c = 500,
  ringbonus_d = 200,
  finish = "result_1125_end"
}
function main(_ARG_0_)
end
function on_talk_setup(_ARG_0_, _ARG_1_)
  if _ARG_1_ == "msg_m1125_125" then
...
function on_goto(_ARG_0_, _ARG_1_)
  if g_mission_information.mission_area == "twn/shadow/c" then
    if _ARG_1_ == "goto_mission_scene" then
      ...
      g_mission_information.mission_set_default = "scripts/mission/1125/set_mission_1125_01.XML"
      g_mission_information.mission_is_battle = true
      ChangeArea(_ARG_0_, g_mission_information.mission_area)
    elseif _ARG_1_ == "goto_mission_end" then
      g_mission_information.mission_terrain = "stage/twn/c"
      g_mission_information.mission_area = "twn/shadow/c"
      g_mission_information.mission_set_default = "scripts/mission/1125/set_mission_1125_00.XML"
