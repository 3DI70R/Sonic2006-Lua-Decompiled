g_mission_information = {
  ...
  mission_set_default = "scripts/mission/1129/set_mission_1129.XML",
...
g_result_1129 = {
  ...
  ringbonus_c = 500,
  ringbonus_d = 200,
  finish = "result_1129_end"
}
function main(_ARG_0_)
end
function on_talk_icon(_ARG_0_, _ARG_1_)
  if _ARG_1_ == "msg_m1129_129" then
...
function on_talk_setup(_ARG_0_, _ARG_1_)
  if _ARG_1_ == "msg_m1129_129" then
    if GetTemporaryFlag(_ARG_0_, c_flag_mission_success) == 1 then
      ...
      g_name_setuped = "msg_m1129_n129"
      g_message_setuped = _ARG_1_ .. "_01_1"
    else
      SetAnimationTalkWith(_ARG_0_, "talk_pointr", "normal")
      g_name_setuped = "msg_m1129_n129"
...
function on_goto(_ARG_0_, _ARG_1_)
  if g_mission_information.mission_area == "twn/shadow/b" then
    if _ARG_1_ == "goto_mission_end" then
      ...
      g_mission_information.mission_set_default = "scripts/mission/1129/set_mission_1129_00.XML"
...
function on_event(_ARG_0_, _ARG_1_)
  if _ARG_1_ == "d1129" then
    SetTemporaryFlag(_ARG_0_, c_flag_mission_success, 1)
    on_goto(_ARG_0_, "goto_mission_end")
  elseif _ARG_1_ == "FAILD_FLAG" then
    MissionClear(_ARG_0_, "failed")
  elseif _ARG_1_ == "result_1129_end" then
    MissionClear(_ARG_0_, "complete")
  elseif _ARG_1_ == "rule" then
    OpenWindow(_ARG_0_, "msg_m1129_rule029_01_1")
  end
end
function on_talk_open(_ARG_0_, _ARG_1_)
end
function on_talk_close(_ARG_0_, _ARG_1_)
  if _ARG_1_ == "msg_m1129_129_01_1" then
    SetTemporaryFlag(_ARG_0_, c_flag_mission_success, 2)
  elseif _ARG_1_ == "msg_m1129_129_01_2" then
    SetGlobalFlag(_ARG_0_, 1129, 1)
    Result(_ARG_0_, "g_result_1129")
  end
end
