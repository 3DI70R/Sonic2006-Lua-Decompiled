g_mission_information = {
  mission_string = "msg_m1003_title003_01_1",
  mission_area = "twn/sonic/a",
  mission_terrain = "stage/twn/a/",
  mission_set_default = "scripts/mission/1003/set_mission_1003_00.XML",
...
g_result_1003 = {
  ...
  ringbonus_c = 200,
  ringbonus_d = 100,
  finish = "result_1003_end"
}
function main(_ARG_0_)
end
function on_talk_icon(_ARG_0_, _ARG_1_)
  if _ARG_1_ == "msg_m1003_003" then
...
function on_goto(_ARG_0_, _ARG_1_)
  if g_mission_information.mission_area == "twn/sonic/a" then
    if _ARG_1_ == "goto_mission_scene" then
      ...
      g_mission_information.mission_set_default = "scripts/mission/1003/set_mission_1003.XML"
      g_mission_information.mission_is_battle = true
      ChangeArea(_ARG_0_, g_mission_information.mission_area)
    elseif _ARG_1_ == "goto_mission_end" then
      g_mission_information.mission_terrain = "stage/twn/a/"
      g_mission_information.mission_area = "twn/sonic/a"
      g_mission_information.mission_set_default = "scripts/mission/1003/set_mission_1003_00.XML"
...
function on_talk_close(_ARG_0_, _ARG_1_)
  if _ARG_1_ == "msg_m1003_003_01_1" then
    SetTemporaryFlag(_ARG_0_, c_flag_mission_start, 1)
    on_goto(_ARG_0_, "goto_mission_scene")
  elseif _ARG_1_ == "msg_m1003_003_01_2" then
    SetGlobalFlag(_ARG_0_, 1003, 1)
    Result(_ARG_0_, "g_result_1003")
  end
end
