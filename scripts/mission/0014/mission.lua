g_mission_information = {
  ...
  mission_set_default = "scripts/mission/0014/set_mission_0014a.XML",
  mission_event_start = "e0027",
  mission_startup = "e0027_end",
...
c_icon_hint = 1
c_icon_mission = 3
script.reload("scripts/mission/0014/mission_talk.lua")
script.reload("scripts/mission/0001/mission_man.lua")
function main(_ARG_0_)
  if GetTemporaryFlag(_ARG_0_, c_flag_0905) == 0 and GetGlobalFlag(_ARG_0_, 55) == 1 then
    SetTemporaryFlag(_ARG_0_, c_flag_0905, 1)
  end
end
...
function on_goto(_ARG_0_, _ARG_1_)
  if g_mission_information.mission_area == "twn/sonic/a" then
    if _ARG_1_ == "goto_b" then
      ...
      g_mission_information.mission_set_default = "scripts/mission/0014/set_mission_0014b.XML"
    ...
    elseif _ARG_1_ == "goto_c" then
      ...
      g_mission_information.mission_set_default = "scripts/mission/0014/set_mission_0014c.XML"
      g_mission_information.mission_is_battle = false
      ChangeArea(_ARG_0_, g_mission_information.mission_area)
    end
...
function on_event(_ARG_0_, _ARG_1_)
  ...
  if _ARG_1_ == "goto_aqa" then
    if GetTemporaryFlag(_ARG_0_, c_flag_0905) == 1 then
  ...
  elseif _ARG_1_ == "me0915" then
    OpenWindow(_ARG_0_, "")
    SetTemporaryFlag(_ARG_0_, c_flag_0903, 1)
    SetTemporaryFlag(_ARG_0_, c_flag_0915, 1)
  elseif _ARG_1_ == "e0027_end" then
  ...
  elseif _ARG_1_ == "e1111_end" then
    ...
    g_mission_information.mission_is_battle = true
    ChangeArea(_ARG_0_, g_mission_information.mission_area)
    g_mission_information.mission_area_text = "eggwyvern"
...
function on_talk_close(_ARG_0_, _ARG_1_)
  ...
  if _ARG_1_ == "msg_t01410a995_01_1" or _ARG_1_ == "msg_t01410b991_01_1" then
    SetTemporaryFlag(_ARG_0_, c_flag_0903, 1)
  end
end
