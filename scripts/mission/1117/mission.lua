g_mission_information = {
  mission_string = "msg_m1117_title017_01_1",
  mission_area = "twn/shadow/a",
  mission_terrain = "stage/twn/a/",
  mission_set_default = "scripts/mission/1117/set_mission_1117_00.XML",
...
g_result_1117 = {
  ...
  ringbonus_c = 200,
  ringbonus_d = 100,
  finish = "result_1117_end"
}
function main(_ARG_0_)
end
function on_talk_icon(_ARG_0_, _ARG_1_)
  if _ARG_1_ == "msg_m1117_117" then
...
function on_goto(_ARG_0_, _ARG_1_)
  if g_mission_information.mission_area == "twn/shadow/a" then
    if _ARG_1_ == "goto_mission_scene" then
      ...
      g_mission_information.mission_set_default = "scripts/mission/1117/set_mission_1117_01.XML"
      g_mission_information.mission_is_battle = true
      ChangeArea(_ARG_0_, g_mission_information.mission_area)
    elseif _ARG_1_ == "goto_mission_end" then
      g_mission_information.mission_terrain = "stage/twn/a"
      g_mission_information.mission_area = "twn/shadow/a"
      g_mission_information.mission_set_default = "scripts/mission/1117/set_mission_1117_00.XML"
...
function on_event(_ARG_0_, _ARG_1_)
  ...
  elseif _ARG_1_ == "failed" then
    ...
    on_goto(_ARG_0_, "goto_mission_end")
    StartCountdown(_ARG_0_, 0, "")
  elseif _ARG_1_ == "result_1117_end" then
    MissionClear(_ARG_0_, "complete")
  elseif _ARG_1_ == "rule" then
    OpenWindow(_ARG_0_, "msg_m1117_rule017_01_1")
...
function on_talk_close(_ARG_0_, _ARG_1_)
  if _ARG_1_ == "msg_m1117_117_01_3" then
    SetTemporaryFlag(_ARG_0_, c_flag_mission_start, 1)
    on_goto(_ARG_0_, "goto_mission_scene")
  elseif _ARG_1_ == "msg_m1117_117_01_4" then
    SetGlobalFlag(_ARG_0_, 1117, 1)
    Result(_ARG_0_, "g_result_1117")
  elseif _ARG_1_ == "msg_m1117_117_01_5" then
