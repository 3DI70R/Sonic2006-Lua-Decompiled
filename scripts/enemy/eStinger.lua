...
Enemy.eStinger_Trans = {
  ...
  Action = function(_ARG_0_)
    MoveSiegeDash(_ARG_0_, 500, 1000, 0.75, 1.25, 1250, 1500, 3)
    TurnTarget(_ARG_0_)
    ShotNormal(_ARG_0_, "Missile")
    ActionRotate(_ARG_0_, "Special", 1, 1)
    WaitFixed(_ARG_0_, 0.5)
    TurnTarget(_ARG_0_)
    EtcTransform(_ARG_0_, 300, 1250, "eStingerFly_Trans", 0.75)
  end,
  Return = function(_ARG_0_)
    ReturnWarp(_ARG_0_)
  end,
