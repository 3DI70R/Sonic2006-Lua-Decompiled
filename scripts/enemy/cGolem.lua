Enemy.cGolem_Normal = {
  Appear = function(_ARG_0_)
    WaitAnimation(_ARG_0_, "CloseWait")
    AppearFixed(_ARG_0_)
  end,
  ...
  Action = function(_ARG_0_)
    ...
    elseif distance < 1500 then
      ChargePossession(_ARG_0_, "effects_point", "CBombL", true)
      ActionFixed(_ARG_0_, "Sub", 1, 1)
      TurnTarget(_ARG_0_)
      ShotPossession(_ARG_0_, "effects_point", 1500)
...
Enemy.cGolem_Fix = {
  ...
  Action = function(_ARG_0_)
    ...
    elseif distance < 1250 then
      ...
      ActionFixed(_ARG_0_, "Sub", 1, 1)
      TurnTarget(_ARG_0_)
      ShotPossession(_ARG_0_, "effects_point", 2500)
      ActionFixed(_ARG_0_, "Main", 1, 1)
      WaitFixed(_ARG_0_, 1.5)
    end
  end,
