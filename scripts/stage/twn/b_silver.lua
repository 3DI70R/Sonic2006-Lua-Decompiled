Town.SilverB = inherits_from(ActionArea)
function Town.SilverA.constructor(_ARG_0_)
  ActionArea.constructor(_ARG_0_)
  Game.Log("construct Town.SilverB")
end
function Town.SilverB.Setup(_ARG_0_)
  ActionArea.Setup(_ARG_0_)
  Game.Log("Town.SilverB.Setup")
  ...
  Game.SetPlayer(16939, 1002, 21245, 0, "silver.lua")
end
